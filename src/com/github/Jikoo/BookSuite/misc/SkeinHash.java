package com.github.Jikoo.BookSuite.misc;
...
public class SkeinHash {
    ...
    private static SkeinHash INITIALIZED = new SkeinHash(512);
    ...
    private SkeinHash(int hashBitCount) {
    ...
    public static void hash(byte[] msg, int bitCount, byte[] digest) {
        ...
        SkeinHash instance = new SkeinHash();
